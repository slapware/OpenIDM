    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ContextMessage ? OpenIDMUserContext.ViewMessage
                : "";
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (responseMessage)
                {
                    ModelState.AddModelError("", OpenIDMUserContext.ViewMessage);
                    return RedirectToAction("Index", new { Message = ManageMessageId.ContextMessage });
                }
                else
                {
                    return View(model);   
